...
for line in open("/home/ubuntu/DL8803/SegNet2/Fextract/test_streaks.txt"):
...
#	rgb_gt[:,:,2] = b_gt/255.0
	...
	plt.figure()
	plt.imsave("/home/ubuntu/data/SegNet2/Fextract/test_streaks_predicted/" + image_names[i], rgb)

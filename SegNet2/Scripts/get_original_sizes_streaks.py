...
test_dir = "/home/ubuntu/data/SegNet2/Fextract/test_streaks_predicted/"
size_dir = "/home/ubuntu/data/SegNet2/Fextract/testannot/"
...
for path in paths:
	...
	cv2.imwrite("/home/ubuntu/data/SegNet2/Fextract/test_streaks_final/" + path.split('.')[0] + '_Segmentation.png' , image_test_resized)

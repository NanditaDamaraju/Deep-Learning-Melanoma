...
for line in open("/home/ubuntu/DL8803/SegNet2/Fextract/test_globules.txt"):
	image_names.append(line.strip().split(' ')[0].split('/')[-1])
...
#	rgb_gt[:,:,2] = b_gt/255.0
	...
	plt.figure()
	plt.imsave("/home/ubuntu/data/SegNet2/Fextract/test_globules_predicted/" + image_names[i], rgb)
